...
<select className={`${mode === "dark" ? "bg-gray-800 text-white" : "bg-gray-300 text-black"} transition-all ease-in-out duration-1000 mt-2 p-2 rounded`} onChange={(e) => setLanguage(e.target.value)}>
      ...
      <Editor
        className={`h-70 my-1 mt-2 border rounded ${mode === "dark" ? "border-white" : "border-gray-700"} transition-all ease-in-out duration-1000 `}
        height="100%"
        language={language}
