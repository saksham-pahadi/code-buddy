  ...
  return (
    <div className=" h-fit  overflow-auto no-scrollbar">
      ...
      <div className={`flex justify-between mt-4`}>
        ...
        <div
          className={`${mode === "dark" ? "bg-gray-800 text-white" : "bg-gray-300 text-black"} transition-all ease-in-out duration-1000 p-2 rounded`}
        >
          <input
            type="file"
        ...
        <button
          ...
          onClick={() => {
              toast.promise(toggleSave(file_id, saved), {
                loading: "Saving...",
                success: (
